export class Creepmod {
  ...
  static upgrader = {role: 'upgrader', part: {WORK:2, CARRY:4, MOVE:3}, num: 1, color: 'green', source: 1}
  static carriager = {role: 'carriager', part: {CARRY:4, MOVE:2}, num: 1, color: 'pink', source: 0}
  static harvester = {role: 'harvester', part: {WORK:3, MOVE:1}, num: 1, color: 'pink', source: 0}
